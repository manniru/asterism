  ...
  connect (server) {
    ...
    this.privateSocketsToRegister.forEach((socketToRegister) => {
      ...
      privateIo.on('connect', (socket) => {
        ...
        socketToRegister.context.privateSocket = socketToRegister.context.privateSocket || socket
      })
    })
    ...
    this.publicSocketsToRegister.forEach((socketToRegister) => {
      ...
      publicIo.on('connect', (socket) => {
        ...
        socketToRegister.context.publicSockets[socketToRegister.namespace] = socketToRegister.context.publicSockets[socketToRegister.namespace] || socket
      })
    })
  }
