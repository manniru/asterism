...
class Server extends EventEmitter {
  ...
  _serverPlug (pluginManifest) {
    ...
    if (pluginManifest.private_socket) {
    ...
    // TODO !1: ajout des sockets publiques serveur: les instancier si pas déjà existantes,
    // TODO !1: les injecter dans le middleware plugin

    // TODO !0: ajout d'un middleware, injection du context, et tester que context possède la socket !
  }
  ...
  _browserPlug (pluginManifest) {
    ...
    if (browserManifest.settingsPanel) {
      ...
      try {
        ...
        this.browserSettingsPanels.push({
          ...
          publicSockets: [] // TODO !1: add public sockets to plug
        })
      } catch (error) {
    ...
    // TODO !1: pareil pour les public sockets.
  }
}
