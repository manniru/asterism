...
class Server extends EventEmitter {
  ...
  _serverPlug (pluginManifest) {
    ...
    // TODO !0: ajout des sockets publiques serveur: les instancier si pas déjà existantes (attention aux doublons, si le cas, bloquer.)
  ...
  _browserPlug (pluginManifest) {
    ...
    if (browserManifest.settingsPanel) {
      ...
      try {
        ...
        this.browserSettingsPanels.push({
          ...
          publicSockets: [] // TODO !0: add public sockets to plug
        })
      } catch (error) {
    ...
    // TODO !0: pareil pour les public sockets.
  }
}
