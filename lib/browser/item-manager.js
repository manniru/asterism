...
const _brokenItem = (id) => (
  <Button key={id} waves='red' className='grey lighten-2 red-text truncate fluid'>
...
class ItemManager {
  ...
  encapsulateItem ({ item, id, w = 1, h = 1, settingPanel = null }) {
    ...
    // TODO !8: perf issue? print <Resizer /> only in edition mode!
    return (
      <Item
        width={w}
        height={h}
      ...
      >
        {item}
        <Resizer
          acceptedDimensions={item.props.acceptedDimensions}
