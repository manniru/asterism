...
export default class ScenariiService {
  ...
  createStateInstance (typeId) {
    return _createElementInstance('state', this.states, typeId)
  }
  setStateData (stateData) {
    return _getElementInstance(this.dataHandler, 'state', this.states, stateData.instanceId)
        ...
        .catch((error) => {
          ...
          return _createElementInstance('state', this.states, stateData.typeId, stateData.data, stateData.instanceId)
        })
        .then((state) => {
          return _setElementInstance(this.dataHandler, 'state', this.states, state)
        })
  }
  ...
  deleteStateInstance (state) {
    return _deleteElementInstance(this.dataHandler, state.instanceId)
  }
